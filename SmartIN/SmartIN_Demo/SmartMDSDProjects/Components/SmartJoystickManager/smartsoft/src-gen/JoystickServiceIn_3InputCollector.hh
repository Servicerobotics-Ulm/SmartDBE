...
//--------------------------------------------------------------------------
#ifndef _JOYSTICKSERVICEIN_3_INPUT_COLLECTOR_HH
#define _JOYSTICKSERVICEIN_3_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** JoystickServiceIn_3InputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort JoystickServiceIn_3 and at the same time acts itself
 ...
 */
class JoystickServiceIn_3InputCollector
:	public Smart::IInputHandler<CommBasicObjects::CommJoystick>
,	public Smart::InputSubject<CommBasicObjects::CommJoystick>
{
public:
	JoystickServiceIn_3InputCollector(Smart::InputSubject<CommBasicObjects::CommJoystick> *subject)
	:	Smart::IInputHandler<CommBasicObjects::CommJoystick>(subject)
	{  }
	virtual ~JoystickServiceIn_3InputCollector() = default;
...
#endif // _JOYSTICKSERVICEIN_3_INPUT_COLLECTOR_HH
