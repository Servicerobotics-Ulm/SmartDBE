...
#ifndef SMARTJOYSTICKMANAGER_EXTENSION_HH_
#define SMARTJOYSTICKMANAGER_EXTENSION_HH_
...
public:
	SmartJoystickManagerExtension(const std::string &name);
	virtual ~SmartJoystickManagerExtension();
...
#endif /* SMARTJOYSTICKMANAGER_EXTENSION_HH_ */
