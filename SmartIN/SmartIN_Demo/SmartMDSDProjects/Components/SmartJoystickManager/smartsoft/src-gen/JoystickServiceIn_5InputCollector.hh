...
//--------------------------------------------------------------------------
#ifndef _JOYSTICKSERVICEIN_5_INPUT_COLLECTOR_HH
#define _JOYSTICKSERVICEIN_5_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** JoystickServiceIn_5InputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort JoystickServiceIn_5 and at the same time acts itself
 ...
 */
class JoystickServiceIn_5InputCollector
:	public Smart::IInputHandler<CommBasicObjects::CommJoystick>
,	public Smart::InputSubject<CommBasicObjects::CommJoystick>
{
public:
	JoystickServiceIn_5InputCollector(Smart::InputSubject<CommBasicObjects::CommJoystick> *subject)
	:	Smart::IInputHandler<CommBasicObjects::CommJoystick>(subject)
	{  }
	virtual ~JoystickServiceIn_5InputCollector() = default;
...
#endif // _JOYSTICKSERVICEIN_5_INPUT_COLLECTOR_HH
