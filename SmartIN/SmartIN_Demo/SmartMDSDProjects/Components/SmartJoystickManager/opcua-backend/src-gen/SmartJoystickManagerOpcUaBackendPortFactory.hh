...
#ifndef SMARTJOYSTICKMANAGER_OPC_UA_BACKEND_PORTFACTORY_HH_
#define SMARTJOYSTICKMANAGER_OPC_UA_BACKEND_PORTFACTORY_HH_
...
class SmartJoystickManagerOpcUaBackendPortFactory: public SmartJoystickManagerPortFactoryInterface
{
private:
	...
	int task_execution();
public:
	SmartJoystickManagerOpcUaBackendPortFactory();
	virtual ~SmartJoystickManagerOpcUaBackendPortFactory();
...
#endif /* SMARTJOYSTICKMANAGER_SERONET_SDK_PORTFACTORY_HH_ */
