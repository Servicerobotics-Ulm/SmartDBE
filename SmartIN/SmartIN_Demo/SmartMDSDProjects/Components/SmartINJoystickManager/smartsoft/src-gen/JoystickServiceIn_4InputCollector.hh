...
//--------------------------------------------------------------------------
#ifndef _JOYSTICKSERVICEIN_4_INPUT_COLLECTOR_HH
#define _JOYSTICKSERVICEIN_4_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** JoystickServiceIn_4InputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort JoystickServiceIn_4 and at the same time acts itself
 ...
 */
class JoystickServiceIn_4InputCollector
:	public Smart::IInputHandler<CommBasicObjects::CommJoystick>
,	public Smart::InputSubject<CommBasicObjects::CommJoystick>
{
public:
	JoystickServiceIn_4InputCollector(Smart::InputSubject<CommBasicObjects::CommJoystick> *subject)
	:	Smart::IInputHandler<CommBasicObjects::CommJoystick>(subject)
	{  }
	virtual ~JoystickServiceIn_4InputCollector() = default;
...
#endif // _JOYSTICKSERVICEIN_4_INPUT_COLLECTOR_HH
