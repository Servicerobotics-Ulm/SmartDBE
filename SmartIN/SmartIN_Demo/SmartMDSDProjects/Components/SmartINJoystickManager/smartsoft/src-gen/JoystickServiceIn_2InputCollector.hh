...
//--------------------------------------------------------------------------
#ifndef _JOYSTICKSERVICEIN_2_INPUT_COLLECTOR_HH
#define _JOYSTICKSERVICEIN_2_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** JoystickServiceIn_2InputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort JoystickServiceIn_2 and at the same time acts itself
 ...
 */
class JoystickServiceIn_2InputCollector
:	public Smart::IInputHandler<CommBasicObjects::CommJoystick>
,	public Smart::InputSubject<CommBasicObjects::CommJoystick>
{
public:
	JoystickServiceIn_2InputCollector(Smart::InputSubject<CommBasicObjects::CommJoystick> *subject)
	:	Smart::IInputHandler<CommBasicObjects::CommJoystick>(subject)
	{  }
	virtual ~JoystickServiceIn_2InputCollector() = default;
...
#endif // _JOYSTICKSERVICEIN_2_INPUT_COLLECTOR_HH
