...
//--------------------------------------------------------------------------
#ifndef _JOYSTICKSERVICEIN_1_INPUT_COLLECTOR_HH
#define _JOYSTICKSERVICEIN_1_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** JoystickServiceIn_1InputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort JoystickServiceIn_1 and at the same time acts itself
 ...
 */
class JoystickServiceIn_1InputCollector
:	public Smart::IInputHandler<CommBasicObjects::CommJoystick>
,	public Smart::InputSubject<CommBasicObjects::CommJoystick>
{
public:
	JoystickServiceIn_1InputCollector(Smart::InputSubject<CommBasicObjects::CommJoystick> *subject)
	:	Smart::IInputHandler<CommBasicObjects::CommJoystick>(subject)
	{  }
	virtual ~JoystickServiceIn_1InputCollector() = default;
...
#endif // _JOYSTICKSERVICEIN_1_INPUT_COLLECTOR_HH
