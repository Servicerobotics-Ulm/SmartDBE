...
#ifndef SMARTINJOYSTICKMANAGER_EXTENSION_HH_
#define SMARTINJOYSTICKMANAGER_EXTENSION_HH_
...
public:
	SmartINJoystickManagerExtension(const std::string &name);
	virtual ~SmartINJoystickManagerExtension();
...
#endif /* SMARTINJOYSTICKMANAGER_EXTENSION_HH_ */
