...
void ParamUpdateHandler::loadParameter(SmartACE::SmartIniParameter &parameter)
{
	...
	try
	{
		...
		//
		// parameter Settings
		if(parameter.getDouble("Settings", "max_steering", commitState.Settings.max_steering))
		{
			globalState.Settings.max_steering = commitState.Settings.max_steering;
		}
		if(parameter.getDouble("Settings", "max_velocity", commitState.Settings.max_velocity))
		{
