...
#ifndef SMARTINJOYSTICKSERVER_ACE_PORTFACTORY_HH_
#define SMARTINJOYSTICKSERVER_ACE_PORTFACTORY_HH_
...
class SmartINJoystickServerAcePortFactory: public SmartINJoystickServerPortFactoryInterface
{
private:
	SmartINJoystickServerImpl *componentImpl;
public:
	SmartINJoystickServerAcePortFactory();
	virtual ~SmartINJoystickServerAcePortFactory();
...
#endif /* SMARTINJOYSTICKSERVER_ACE_PORTFACTORY_HH_ */
