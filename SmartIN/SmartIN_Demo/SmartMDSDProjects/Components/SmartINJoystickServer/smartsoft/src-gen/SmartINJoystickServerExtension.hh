...
#ifndef SMARTINJOYSTICKSERVER_EXTENSION_HH_
#define SMARTINJOYSTICKSERVER_EXTENSION_HH_
...
public:
	SmartINJoystickServerExtension(const std::string &name);
	virtual ~SmartINJoystickServerExtension();
...
#endif /* SMARTINJOYSTICKSERVER_EXTENSION_HH_ */
