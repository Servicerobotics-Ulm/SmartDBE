...
//--------------------------------------------------------------------------
#ifndef _EVENT_LISTENER_INPUT_COLLECTOR_HH
#define _EVENT_LISTENER_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** Event_ListenerInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort Event_Listener and at the same time acts itself
 ...
 */
class Event_ListenerInputCollector
:	public Smart::IInputHandler<Smart::EventInputType<SmartInstitutionsServiceRepository::SmartIN_EventType>>
,	public Smart::InputSubject<Smart::EventInputType<SmartInstitutionsServiceRepository::SmartIN_EventType>>
{
public:
	Event_ListenerInputCollector(Smart::InputSubject<Smart::EventInputType<SmartInstitutionsServiceRepository::SmartIN_EventType>> *subject)
	:	Smart::IInputHandler<Smart::EventInputType<SmartInstitutionsServiceRepository::SmartIN_EventType>>(subject)
	{  }
	virtual ~Event_ListenerInputCollector() = default;
...
#endif // _EVENT_LISTENER_INPUT_COLLECTOR_HH
