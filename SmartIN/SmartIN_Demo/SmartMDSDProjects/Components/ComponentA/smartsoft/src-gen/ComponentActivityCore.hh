...
//--------------------------------------------------------------------------
#ifndef _COMPONENTACTIVITY_CORE_HH
#define _COMPONENTACTIVITY_CORE_HH
...
private:
	...
	std::list<ComponentActivityObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(ComponentActivityObserverInterface *observer);
	void detach_interaction_observer(ComponentActivityObserverInterface *observer);

public:
	ComponentActivityCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~ComponentActivityCore();
