...
EventManager::EventManager(SmartACE::SmartComponent *comp) 
:	EventManagerCore(comp)
{
	std::cout << "constructor EventManager\n";
}
...
void EventManager::on_Event_Listener(const Smart::EventInputType<SmartInstitutions_ServiceRepository::SmartIN_EventType> &input)
{
	...
	// - do not use longer blocking calls here since this upcall blocks the InputPort Event_Listener
