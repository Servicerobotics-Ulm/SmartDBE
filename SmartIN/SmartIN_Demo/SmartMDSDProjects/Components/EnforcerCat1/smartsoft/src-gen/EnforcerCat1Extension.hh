...
#ifndef ENFORCERCAT1_EXTENSION_HH_
#define ENFORCERCAT1_EXTENSION_HH_
...
public:
	EnforcerCat1Extension(const std::string &name);
	virtual ~EnforcerCat1Extension();
...
#endif /* ENFORCERCAT1_EXTENSION_HH_ */
