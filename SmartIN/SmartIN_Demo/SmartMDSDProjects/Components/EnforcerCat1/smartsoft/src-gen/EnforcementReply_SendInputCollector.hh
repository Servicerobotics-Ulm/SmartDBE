...
//--------------------------------------------------------------------------
#ifndef _ENFORCEMENTREPLY_SEND_INPUT_COLLECTOR_HH
#define _ENFORCEMENTREPLY_SEND_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** EnforcementReply_SendInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort EnforcementReply_Send and at the same time acts itself
 ...
 */
class EnforcementReply_SendInputCollector
...
{
public:
	EnforcementReply_SendInputCollector(Smart::InputSubject<SmartInstitutionsServiceRepository::EnforcementReplyPackage> *subject)
	:	Smart::IInputHandler<SmartInstitutionsServiceRepository::EnforcementReplyPackage>(subject)
	{  }
	virtual ~EnforcementReply_SendInputCollector() = default;
...
#endif // _ENFORCEMENTREPLY_SEND_INPUT_COLLECTOR_HH
