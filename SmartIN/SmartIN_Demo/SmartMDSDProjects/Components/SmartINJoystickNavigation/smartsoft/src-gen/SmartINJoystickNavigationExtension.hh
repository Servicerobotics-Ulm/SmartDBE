...
#ifndef SMARTINJOYSTICKNAVIGATION_EXTENSION_HH_
#define SMARTINJOYSTICKNAVIGATION_EXTENSION_HH_
...
public:
	SmartINJoystickNavigationExtension(const std::string &name);
	virtual ~SmartINJoystickNavigationExtension();
...
#endif /* SMARTINJOYSTICKNAVIGATION_EXTENSION_HH_ */
