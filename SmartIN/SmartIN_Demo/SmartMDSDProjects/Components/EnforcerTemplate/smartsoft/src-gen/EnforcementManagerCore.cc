...
,	enforcementReply_PushStatus(Smart::SMART_DISCONNECTED)
,	enforcementReply_PushObject()
,	enforcementReply_SendStatus(Smart::SMART_DISCONNECTED)
,	enforcementReply_SendObject()
,	enforcementReport_PushStatus(Smart::SMART_DISCONNECTED)
,	enforcementReport_PushObject()
...
{
	enforcementReply_PushStatus = COMP->enforcementReply_PushInputTaskTrigger->getUpdate(enforcementReply_PushObject);
	enforcementReply_SendStatus = COMP->enforcementReply_SendInputTaskTrigger->getUpdate(enforcementReply_SendObject);
	enforcementReport_PushStatus = COMP->enforcementReport_PushInputTaskTrigger->getUpdate(enforcementReport_PushObject);
