...
#ifndef ENFORCERTEMPLATE_EXTENSION_HH_
#define ENFORCERTEMPLATE_EXTENSION_HH_
...
public:
	EnforcerTemplateExtension(const std::string &name);
	virtual ~EnforcerTemplateExtension();
...
#endif /* ENFORCERTEMPLATE_EXTENSION_HH_ */
