#!/bin/bash
#
# Start-Stop-Hooks for component SafetyOfficer
#
...
pre-start)
	...
	bash startstop-hooks-component-SmartINJoystickServer.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartINJoystickServer.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartINJoystickServer.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartINJoystickServer.sh post-stop
