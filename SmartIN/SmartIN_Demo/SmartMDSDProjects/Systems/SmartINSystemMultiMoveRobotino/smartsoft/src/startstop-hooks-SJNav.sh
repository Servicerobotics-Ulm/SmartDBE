#!/bin/bash
#
# Start-Stop-Hooks for component SJNav
#
...
pre-start)
	...
	bash startstop-hooks-component-SmartINJoystickNavigation.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartINJoystickNavigation.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartINJoystickNavigation.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartINJoystickNavigation.sh post-stop
