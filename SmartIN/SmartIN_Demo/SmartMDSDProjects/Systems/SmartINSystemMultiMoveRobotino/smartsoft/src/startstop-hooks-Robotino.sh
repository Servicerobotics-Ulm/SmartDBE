#!/bin/bash
#
# Start-Stop-Hooks for component Robotino
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentWebotsMobileRobot.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsMobileRobot.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsMobileRobot.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsMobileRobot.sh post-stop
