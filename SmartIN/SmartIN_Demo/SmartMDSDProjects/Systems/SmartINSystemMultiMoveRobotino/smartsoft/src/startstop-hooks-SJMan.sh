#!/bin/bash
#
# Start-Stop-Hooks for component SJMan
#
...
pre-start)
	...
	bash startstop-hooks-component-SmartINJoystickManager.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartINJoystickManager.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartINJoystickManager.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartINJoystickManager.sh post-stop
