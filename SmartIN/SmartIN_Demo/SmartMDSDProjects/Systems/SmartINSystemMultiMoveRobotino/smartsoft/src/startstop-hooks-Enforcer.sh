#!/bin/bash
#
# Start-Stop-Hooks for component Enforcer
#
...
pre-start)
	...
	bash startstop-hooks-component-EnforcerCat1.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-EnforcerCat1.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-EnforcerCat1.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-EnforcerCat1.sh post-stop
