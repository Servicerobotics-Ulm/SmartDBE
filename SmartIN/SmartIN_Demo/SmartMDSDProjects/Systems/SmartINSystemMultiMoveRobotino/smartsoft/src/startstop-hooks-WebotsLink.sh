#!/bin/bash
#
# Start-Stop-Hooks for component WebotsLink
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentWebots.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebots.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebots.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebots.sh post-stop
