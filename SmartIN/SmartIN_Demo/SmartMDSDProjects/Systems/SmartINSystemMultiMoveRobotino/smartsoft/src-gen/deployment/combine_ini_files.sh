...
# create ini-file Enforcer.ini
echo "create ini-file Enforcer.ini"
cp src-gen/system/Enforcer.ini src-gen/combined-ini-files/
if [ -f src-gen/params/Enforcer.ini ]; then
  cat src-gen/params/Enforcer.ini >> src-gen/combined-ini-files/Enforcer.ini
fi
