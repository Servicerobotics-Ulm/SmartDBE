...
# Component instance Enforcer
echo
echo "############################################"
echo "## Starting component instance Enforcer"
cd $SCRIPT_DIR
echo "executing startstop-hooks-Enforcer.sh (errors might be ignored)"
bash startstop-hooks-Enforcer.sh pre-start
cd $SCRIPT_DIR/Enforcer_data
rm -f "../Enforcer.log"
xterm -l -lf "../Enforcer.log" -title "Enforcer@LocalhostTarget Component" -hold -e "export LD_LIBRARY_PATH=$SCRIPT_DIR:\$LD_LIBRARY_PATH; $SCRIPT_DIR/EnforcerCat1 -filename=$SCRIPT_DIR/Enforcer.ini; echo; echo; echo 'Enforcer exited.'; echo; /bin/bash --login" &
echo $! >> $PID_XTERM
echo EnforcerCat1 >> $PID_COMPONENT_NAMES
cd $SCRIPT_DIR
bash startstop-hooks-Enforcer.sh post-start
echo -e "\n\n\n"
...
xterm -l -lf "../RobotOperator.log" -title "RobotOperator@LocalhostTarget Component" -hold -e "export LD_LIBRARY_PATH=$SCRIPT_DIR:\$LD_LIBRARY_PATH; $SCRIPT_DIR/SmartINJoystickServer -filename=$SCRIPT_DIR/RobotOperator.ini; echo; echo; echo 'RobotOperator exited.'; echo; /bin/bash --login" &
echo $! >> $PID_XTERM
echo SmartINJoystickServer >> $PID_COMPONENT_NAMES
cd $SCRIPT_DIR
...
rm -f "../SJMan.log"
xterm -l -lf "../SJMan.log" -title "SJMan@LocalhostTarget Component" -hold -e "export LD_LIBRARY_PATH=$SCRIPT_DIR:\$LD_LIBRARY_PATH; $SCRIPT_DIR/SmartINJoystickManager -filename=$SCRIPT_DIR/SJMan.ini; echo; echo; echo 'SJMan exited.'; echo; /bin/bash --login" &
echo $! >> $PID_XTERM
echo SmartINJoystickManager >> $PID_COMPONENT_NAMES
cd $SCRIPT_DIR
...
rm -f "../SJNav.log"
xterm -l -lf "../SJNav.log" -title "SJNav@LocalhostTarget Component" -hold -e "export LD_LIBRARY_PATH=$SCRIPT_DIR:\$LD_LIBRARY_PATH; $SCRIPT_DIR/SmartINJoystickNavigation -filename=$SCRIPT_DIR/SJNav.ini; echo; echo; echo 'SJNav exited.'; echo; /bin/bash --login" &
echo $! >> $PID_XTERM
echo SmartINJoystickNavigation >> $PID_COMPONENT_NAMES
cd $SCRIPT_DIR
...
xterm -l -lf "../SafetyOfficer.log" -title "SafetyOfficer@LocalhostTarget Component" -hold -e "export LD_LIBRARY_PATH=$SCRIPT_DIR:\$LD_LIBRARY_PATH; $SCRIPT_DIR/SmartINJoystickServer -filename=$SCRIPT_DIR/SafetyOfficer.ini; echo; echo; echo 'SafetyOfficer exited.'; echo; /bin/bash --login" &
echo $! >> $PID_XTERM
echo SmartINJoystickServer >> $PID_COMPONENT_NAMES
cd $SCRIPT_DIR
...
stop)
cd $SCRIPT_DIR
bash startstop-hooks-Enforcer.sh pre-stop
...
bash startstop-hooks-Enforcer.sh post-stop
