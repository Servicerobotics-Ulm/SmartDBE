...
// serialization for CommPosition3dWithCovariance
template <>
inline IDescription::shp_t SelfDescription(CommBasicObjects::CommPosition3dWithCovariance *obj, std::string name)
{
