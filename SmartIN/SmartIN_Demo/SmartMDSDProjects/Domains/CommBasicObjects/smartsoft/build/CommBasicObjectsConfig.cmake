...
IF(EXISTS ${CMAKE_CURRENT_LIST_DIR}/CMakeCache.txt)
	...
	FOREACH(DEPENDENCY IN ITEMS SmartXml;Armadillo;SmartProperty;TransformationMatrices)
...
INCLUDE(${CMAKE_CURRENT_LIST_DIR}/CommBasicObjectsTargets.cmake)

# the following variables are depricated and should not be used anymore:
# CommBasicObjects_LIBRARIES
# CommBasicObjects_INCLUDES

# instead, just directly link the library CommBasicObjects to your executable target like this:
#
# TARGET_LINK_LIBRARIES(YourExecutableTarget CommBasicObjects)
#
# (all the includes and additional libraries are automatically determined from the target CommBasicObjects)
