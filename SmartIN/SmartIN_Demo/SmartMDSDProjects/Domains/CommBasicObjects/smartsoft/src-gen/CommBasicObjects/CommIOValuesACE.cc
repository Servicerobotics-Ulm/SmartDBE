...
// serialization operator for element CommIOValues
...
// de-serialization operator for element CommIOValues
ACE_CDR::Boolean operator>>(ACE_InputCDR &cdr, CommBasicObjectsIDL::CommIOValues &data)
{
	...
	CommBasicObjectsIDL::CommAnalogOutputRequest data_analogOutputValuesItem;
	...
	CommBasicObjectsIDL::CommDigitalOutputRequest data_digitalOutputValuesItem;
