...
ACE_CDR::Boolean operator>>(ACE_InputCDR &cdr, SmartInstitutionsServiceRepositoryIDL::InstitutionStatus &data)
{
	...
	SmartInstitutionsServiceRepositoryIDL::MemberIdentifier data_institutionMembersItem;
	...
	SmartInstitutionsServiceRepositoryIDL::MemberIdentifier data_institutionEnforcersItem;
