...
namespace SmartInstitutionsServiceRepository 
{
	...
	void EnforcementInstructionPackageCore::getAllHashValues(std::list<std::string> &hashes)
	{
		...
		// get hash value(s) for SmartInstitutionsServiceRepository::PackageIdentifier(idl_EnforcementInstructionPackage.id)
		SmartInstitutionsServiceRepository::PackageIdentifier::getAllHashValues(hashes);
		// get hash value(s) for SmartInstitutionsServiceRepository::MemberIdentifier(idl_EnforcementInstructionPackage.to)
		SmartInstitutionsServiceRepository::MemberIdentifier::getAllHashValues(hashes);
		// get hash value(s) for SmartInstitutionsServiceRepository::MemberIdentifier(idl_EnforcementInstructionPackage.from)
		SmartInstitutionsServiceRepository::MemberIdentifier::getAllHashValues(hashes);
		// get hash value(s) for SmartInstitutionsServiceRepository::InstitutionStatus(idl_EnforcementInstructionPackage.context)
	...
	void EnforcementInstructionPackageCore::checkAllHashValues(std::list<std::string> &hashes)
	{
		...
		// check hash value(s) for SmartInstitutionsServiceRepository::PackageIdentifier(idl_EnforcementInstructionPackage.id)
		SmartInstitutionsServiceRepository::PackageIdentifier::checkAllHashValues(hashes);
		// check hash value(s) for SmartInstitutionsServiceRepository::MemberIdentifier(idl_EnforcementInstructionPackage.to)
		SmartInstitutionsServiceRepository::MemberIdentifier::checkAllHashValues(hashes);
		// check hash value(s) for SmartInstitutionsServiceRepository::MemberIdentifier(idl_EnforcementInstructionPackage.from)
		SmartInstitutionsServiceRepository::MemberIdentifier::checkAllHashValues(hashes);
		// check hash value(s) for SmartInstitutionsServiceRepository::InstitutionStatus(idl_EnforcementInstructionPackage.context)
	...
	{  
		...
		setInstruction(SmartInstitutionsServiceRepository::EnforcementInstruction());
		setIfCustom("");
	}
	...
	void EnforcementInstructionPackageCore::from_xml(std::istream &is) {
		...
		if(kmp_instruction.search(is)) {
			SmartInstitutionsServiceRepository::EnforcementInstruction instructionItem;
