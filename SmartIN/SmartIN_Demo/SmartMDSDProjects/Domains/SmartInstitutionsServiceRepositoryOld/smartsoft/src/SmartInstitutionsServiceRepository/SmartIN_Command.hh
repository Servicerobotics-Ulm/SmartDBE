...
//--------------------------------------------------------------------------
#ifndef SMARTINSTITUTIONS_SERVICEREPOSITORY_SMARTIN_COMMAND_H_
#define SMARTINSTITUTIONS_SERVICEREPOSITORY_SMARTIN_COMMAND_H_
...
class SmartIN_Command : public SmartIN_CommandCore {
	public:
		 ...
		 */
		// SmartIN_Command(const unsigned long int &commandID, const std::string &command);
...
#endif /* SMARTINSTITUTIONS_SERVICEREPOSITORY_SMARTIN_COMMAND_H_ */
