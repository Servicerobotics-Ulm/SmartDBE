...
SmartIN_EventStateType::SmartIN_EventStateType(const std::vector<SmartInstitutions_ServiceRepository::MemberIdentifier> &targets, const SmartInstitutions_ServiceRepository::SmartIN_EventMessage &message)
