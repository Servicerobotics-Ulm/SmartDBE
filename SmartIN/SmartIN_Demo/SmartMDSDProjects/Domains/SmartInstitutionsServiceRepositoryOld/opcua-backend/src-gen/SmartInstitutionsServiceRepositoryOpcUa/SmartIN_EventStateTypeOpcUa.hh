...
// serialization for SmartIN_EventStateType
template <>
inline IDescription::shp_t SelfDescription(SmartInstitutionsServiceRepository::SmartIN_EventStateType *obj, std::string name)
{
