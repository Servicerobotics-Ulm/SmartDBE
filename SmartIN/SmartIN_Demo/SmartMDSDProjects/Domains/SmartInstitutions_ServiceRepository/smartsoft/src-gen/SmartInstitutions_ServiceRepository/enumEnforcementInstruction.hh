...
//--------------------------------------------------------------------------
#ifndef SMARTINSTITUTIONS_SERVICEREPOSITORY_ENFORCEMENTINSTRUCTION_ENUM_H_
#define SMARTINSTITUTIONS_SERVICEREPOSITORY_ENFORCEMENTINSTRUCTION_ENUM_H_
...
namespace SmartInstitutions_ServiceRepository {
	...
	private:
		SmartInstitutions_ServiceRepositoryIDL::EnforcementInstruction value;
	...
	public:
		...
		EnforcementInstruction(SmartInstitutions_ServiceRepositoryIDL::EnforcementInstruction e) {
			value = e;
		}
		
		//const SmartInstitutions_ServiceRepositoryIDL::EnforcementInstruction& get() const { return value; }
