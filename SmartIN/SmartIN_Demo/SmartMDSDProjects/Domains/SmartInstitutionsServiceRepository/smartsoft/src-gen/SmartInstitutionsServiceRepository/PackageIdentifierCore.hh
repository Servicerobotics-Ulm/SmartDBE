...
//--------------------------------------------------------------------------
#ifndef SMARTINSTITUTIONSSERVICEREPOSITORY_PACKAGEIDENTIFIER_CORE_H_
#define SMARTINSTITUTIONSSERVICEREPOSITORY_PACKAGEIDENTIFIER_CORE_H_
...
protected:
	// data structure
	SmartInstitutionsServiceRepositoryIDL::PackageIdentifier idl_PackageIdentifier;
	
public:
	// give a publicly accessible type-name for the template parameter IDL
	typedef SmartInstitutionsServiceRepositoryIDL::PackageIdentifier DATATYPE;
	...
	static inline std::string identifier(void) { return "SmartInstitutionsServiceRepository::PackageIdentifier"; }
...
#endif /* SMARTINSTITUTIONSSERVICEREPOSITORY_PACKAGEIDENTIFIER_CORE_H_ */
