...
EnforcementReplyPackage::EnforcementReplyPackage(const SmartInstitutionsServiceRepository::PackageIdentifier &id, const SmartInstitutionsServiceRepository::PackageIdentifier &replyingto, const SmartInstitutionsServiceRepository::MemberIdentifier &to, const SmartInstitutionsServiceRepository::MemberIdentifier &from, const SmartInstitutionsServiceRepository::InstitutionStatus &context, const std::string &reply)
