...
// serialization for InstitutionIdentifier
template <>
inline IDescription::shp_t SelfDescription(SmartInstitutionsServiceRepository::InstitutionIdentifier *obj, std::string name)
{
