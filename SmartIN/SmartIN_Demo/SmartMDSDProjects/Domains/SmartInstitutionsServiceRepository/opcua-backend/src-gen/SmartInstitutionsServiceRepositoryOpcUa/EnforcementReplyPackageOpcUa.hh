...
// serialization for EnforcementReplyPackage
template <>
inline IDescription::shp_t SelfDescription(SmartInstitutionsServiceRepository::EnforcementReplyPackage *obj, std::string name)
{
