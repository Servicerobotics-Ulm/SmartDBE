...
// serialization for SmartIN_EventMessage
template <>
inline IDescription::shp_t SelfDescription(SmartInstitutionsServiceRepository::SmartIN_EventMessage *obj, std::string name)
{
