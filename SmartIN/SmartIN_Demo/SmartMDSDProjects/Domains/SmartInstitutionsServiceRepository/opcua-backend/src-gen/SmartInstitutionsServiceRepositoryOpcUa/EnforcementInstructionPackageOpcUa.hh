...
// serialization for EnforcementInstructionPackage
template <>
inline IDescription::shp_t SelfDescription(SmartInstitutionsServiceRepository::EnforcementInstructionPackage *obj, std::string name)
{
