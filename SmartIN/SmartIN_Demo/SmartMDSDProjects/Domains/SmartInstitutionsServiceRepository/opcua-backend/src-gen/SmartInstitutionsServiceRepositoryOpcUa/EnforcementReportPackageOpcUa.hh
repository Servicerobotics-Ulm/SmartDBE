...
// serialization for EnforcementReportPackage
template <>
inline IDescription::shp_t SelfDescription(SmartInstitutionsServiceRepository::EnforcementReportPackage *obj, std::string name)
{
