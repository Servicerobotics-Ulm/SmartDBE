...
// serialization for CommVisualLocalizationFeatureMap
template <>
inline IDescription::shp_t SelfDescription(CommLocalizationObjects::CommVisualLocalizationFeatureMap *obj, std::string name)
{
