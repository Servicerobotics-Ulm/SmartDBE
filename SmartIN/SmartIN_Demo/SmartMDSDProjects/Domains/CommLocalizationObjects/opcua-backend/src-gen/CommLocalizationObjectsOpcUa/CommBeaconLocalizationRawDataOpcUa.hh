...
// serialization for CommBeaconLocalizationRawData
template <>
inline IDescription::shp_t SelfDescription(CommLocalizationObjects::CommBeaconLocalizationRawData *obj, std::string name)
{
