...
// serialization for CommVisualLocalizationFeature
template <>
inline IDescription::shp_t SelfDescription(CommLocalizationObjects::CommVisualLocalizationFeature *obj, std::string name)
{
