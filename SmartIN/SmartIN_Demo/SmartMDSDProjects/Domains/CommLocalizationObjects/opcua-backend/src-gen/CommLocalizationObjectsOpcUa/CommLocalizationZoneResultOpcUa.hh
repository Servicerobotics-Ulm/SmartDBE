...
// serialization for CommLocalizationZoneResult
template <>
inline IDescription::shp_t SelfDescription(CommLocalizationObjects::CommLocalizationZoneResult *obj, std::string name)
{
