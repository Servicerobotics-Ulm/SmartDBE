...
// serialization for CommLocalizationZoneChange
template <>
inline IDescription::shp_t SelfDescription(CommLocalizationObjects::CommLocalizationZoneChange *obj, std::string name)
{
