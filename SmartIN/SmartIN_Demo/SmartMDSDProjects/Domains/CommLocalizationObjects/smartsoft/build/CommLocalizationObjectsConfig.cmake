...
INCLUDE(${CMAKE_CURRENT_LIST_DIR}/CommLocalizationObjectsTargets.cmake)

# the following variables are depricated and should not be used anymore:
# CommLocalizationObjects_LIBRARIES
# CommLocalizationObjects_INCLUDES

# instead, just directly link the library CommLocalizationObjects to your executable target like this:
#
# TARGET_LINK_LIBRARIES(YourExecutableTarget CommLocalizationObjects)
#
# (all the includes and additional libraries are automatically determined from the target CommLocalizationObjects)
