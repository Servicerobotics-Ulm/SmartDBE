...
LIST(APPEND CommLocalizationObjects_DEPENDENCIES SmartXml)

# modelled CommunicationObject-dependencies are added here (if there are any)
LIST(APPEND CommLocalizationObjects_DEPENDENCIES CommBasicObjects)
LIST(APPEND CommLocalizationObjects_DEPENDENCIES CommBasicObjects)

# these are the dependencies that have been added manually within the CMakeLists.txt file
# (e.g. added by SMART_ADD_UTILITY)
LIST(APPEND CommLocalizationObjects_DEPENDENCIES )

LIST(REMOVE_DUPLICATES CommLocalizationObjects_DEPENDENCIES)
