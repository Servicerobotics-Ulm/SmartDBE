...
//--------------------------------------------------------------------------
#ifndef COMMLOCALIZATIONOBJECTS_COMMBEACONLOCALIZATIONRAWDATA_ACE_H_
#define COMMLOCALIZATIONOBJECTS_COMMBEACONLOCALIZATIONRAWDATA_ACE_H_

#include "CommLocalizationObjects/CommBeaconLocalizationRawData.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure CommBeaconLocalizationRawData
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const CommLocalizationObjectsIDL::CommBeaconLocalizationRawData &data);

// de-serialization operator for DataStructure CommBeaconLocalizationRawData
...
#endif /* COMMLOCALIZATIONOBJECTS_COMMBEACONLOCALIZATIONRAWDATA_ACE_H_ */
