...
#include "CommLocalizationZoneChangeJSON.hh"
...
{
	// newZone: Int32
	j["newZone"] = obj.newZone;
	// oldZone: Int32
	j["oldZone"] = obj.oldZone;
...
{
	// newZone: Int32
	if(j.contains("newZone") && j["newZone"].is_number_integer()) {
		obj.newZone = j["newZone"].get<int>();
	}
	// oldZone: Int32
	if(j.contains("oldZone") && j["oldZone"].is_number_integer()) {
		obj.oldZone = j["oldZone"].get<int>();
	}
	// timestamp: CommTimeStamp
