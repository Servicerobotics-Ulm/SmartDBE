...
//--------------------------------------------------------------------------
#ifndef COMMNAVIGATIONOBJECTS_COMMCORRIDORNODE_ACE_H_
#define COMMNAVIGATIONOBJECTS_COMMCORRIDORNODE_ACE_H_

#include "CommNavigationObjects/CommCorridorNode.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure CommCorridorNode
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const CommNavigationObjectsIDL::CommCorridorNode &data);

// de-serialization operator for DataStructure CommCorridorNode
...
#endif /* COMMNAVIGATIONOBJECTS_COMMCORRIDORNODE_ACE_H_ */
