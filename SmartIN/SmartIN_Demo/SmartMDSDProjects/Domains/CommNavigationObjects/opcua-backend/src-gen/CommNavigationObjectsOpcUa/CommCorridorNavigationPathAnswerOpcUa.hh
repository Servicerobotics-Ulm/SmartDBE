...
// serialization for CommCorridorNavigationPathAnswer
template <>
inline IDescription::shp_t SelfDescription(CommNavigationObjects::CommCorridorNavigationPathAnswer *obj, std::string name)
{
