...
// serialization for CommCorridorNavigationGoalEventResult
template <>
inline IDescription::shp_t SelfDescription(CommNavigationObjects::CommCorridorNavigationGoalEventResult *obj, std::string name)
{
