...
public:
	...
	virtual Smart::IPushServerPattern<DomainTSDemo::Coordinate3D> * createPush_Coordinate3D_Output_Port(const std::string &serviceName) override;
	virtual Smart::IQueryServerPattern<DomainTSDemo::Coordinate2D, DomainTSDemo::BasicBoolean> * createQuery_ValidCoordinate2D_Answer_Port(const std::string &serviceName) override;
