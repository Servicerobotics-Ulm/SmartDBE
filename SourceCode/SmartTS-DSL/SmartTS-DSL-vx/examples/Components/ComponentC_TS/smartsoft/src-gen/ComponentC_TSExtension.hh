...
#ifndef COMPONENTC_TS_EXTENSION_HH_
#define COMPONENTC_TS_EXTENSION_HH_
...
public:
	ComponentC_TSExtension(const std::string &name);
	virtual ~ComponentC_TSExtension();
...
#endif /* COMPONENTC_TS_EXTENSION_HH_ */
