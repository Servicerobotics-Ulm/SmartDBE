...
// serialization for CommDigitalInputEventResult
template <>
inline IDescription::shp_t SelfDescription(CommBasicObjects::CommDigitalInputEventResult *obj, std::string name)
{
