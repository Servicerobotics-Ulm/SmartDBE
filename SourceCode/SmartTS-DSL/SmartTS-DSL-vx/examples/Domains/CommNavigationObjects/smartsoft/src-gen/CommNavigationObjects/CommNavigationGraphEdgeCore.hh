...
//--------------------------------------------------------------------------
#ifndef COMMNAVIGATIONOBJECTS_COMMNAVIGATIONGRAPHEDGE_CORE_H_
#define COMMNAVIGATIONOBJECTS_COMMNAVIGATIONGRAPHEDGE_CORE_H_
...
protected:
	// data structure
	CommNavigationObjectsIDL::CommNavigationGraphEdge idl_CommNavigationGraphEdge;
	
public:
	// give a publicly accessible type-name for the template parameter IDL
	typedef CommNavigationObjectsIDL::CommNavigationGraphEdge DATATYPE;
	...
	static inline std::string identifier(void) { return "CommNavigationObjects::CommNavigationGraphEdge"; }
	...
	inline CommNavigationObjects::EDGE_TYPE getType() const { return CommNavigationObjects::EDGE_TYPE(idl_CommNavigationGraphEdge.type); }
	inline CommNavigationGraphEdgeCore& setType(const CommNavigationObjects::EDGE_TYPE &type) { idl_CommNavigationGraphEdge.type = type; return *this; }
};

} /* namespace CommNavigationObjects */
#endif /* COMMNAVIGATIONOBJECTS_COMMNAVIGATIONGRAPHEDGE_CORE_H_ */
