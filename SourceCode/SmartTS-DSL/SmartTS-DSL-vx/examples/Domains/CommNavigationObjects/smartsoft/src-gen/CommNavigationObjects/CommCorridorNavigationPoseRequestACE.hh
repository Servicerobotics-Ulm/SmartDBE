...
//--------------------------------------------------------------------------
#ifndef COMMNAVIGATIONOBJECTS_COMMCORRIDORNAVIGATIONPOSEREQUEST_ACE_H_
#define COMMNAVIGATIONOBJECTS_COMMCORRIDORNAVIGATIONPOSEREQUEST_ACE_H_

#include "CommNavigationObjects/CommCorridorNavigationPoseRequest.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure CommCorridorNavigationPoseRequest
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const CommNavigationObjectsIDL::CommCorridorNavigationPoseRequest &data);

// de-serialization operator for DataStructure CommCorridorNavigationPoseRequest
...
#endif /* COMMNAVIGATIONOBJECTS_COMMCORRIDORNAVIGATIONPOSEREQUEST_ACE_H_ */
