...
// serialization for CommCorridorNetworkLayout
template <>
inline IDescription::shp_t SelfDescription(CommNavigationObjects::CommCorridorNetworkLayout *obj, std::string name)
{
