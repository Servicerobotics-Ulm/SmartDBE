...
// serialization for CommCorridorNetworkStatus
template <>
inline IDescription::shp_t SelfDescription(CommNavigationObjects::CommCorridorNetworkStatus *obj, std::string name)
{
