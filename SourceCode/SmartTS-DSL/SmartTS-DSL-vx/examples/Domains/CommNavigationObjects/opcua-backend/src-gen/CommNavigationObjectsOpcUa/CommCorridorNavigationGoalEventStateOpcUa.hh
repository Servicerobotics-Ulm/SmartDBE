...
// serialization for CommCorridorNavigationGoalEventState
template <>
inline IDescription::shp_t SelfDescription(CommNavigationObjects::CommCorridorNavigationGoalEventState *obj, std::string name)
{
