...
// serialization for CommNavigationObjectsIDL::CommNavigationPaths
template <>
IDescription::shp_t SelfDescription(CommNavigationObjectsIDL::CommNavigationPaths *obj, std::string name)
{
