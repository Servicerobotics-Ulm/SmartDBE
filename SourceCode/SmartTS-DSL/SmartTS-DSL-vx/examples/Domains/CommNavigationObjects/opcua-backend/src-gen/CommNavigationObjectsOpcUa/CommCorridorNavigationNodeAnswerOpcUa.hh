...
// serialization for CommCorridorNavigationNodeAnswer
template <>
inline IDescription::shp_t SelfDescription(CommNavigationObjects::CommCorridorNavigationNodeAnswer *obj, std::string name)
{
