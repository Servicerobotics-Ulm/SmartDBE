...
// serialization for CommCorridorNavigationNodeRequest
template <>
inline IDescription::shp_t SelfDescription(CommNavigationObjects::CommCorridorNavigationNodeRequest *obj, std::string name)
{
