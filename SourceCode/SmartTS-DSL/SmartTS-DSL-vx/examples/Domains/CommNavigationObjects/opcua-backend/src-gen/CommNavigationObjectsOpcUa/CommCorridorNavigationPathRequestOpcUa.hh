...
// serialization for CommCorridorNavigationPathRequest
template <>
inline IDescription::shp_t SelfDescription(CommNavigationObjects::CommCorridorNavigationPathRequest *obj, std::string name)
{
