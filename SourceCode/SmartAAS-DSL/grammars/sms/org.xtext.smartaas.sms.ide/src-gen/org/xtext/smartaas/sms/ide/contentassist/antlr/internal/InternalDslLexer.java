...
public class InternalDslLexer extends Lexer {
    ...
    public final void mT__15() throws RecognitionException {
        try {
            int _type = T__15;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDsl.g:15:7: ( ']]AASEntriesLOG_FINISH]]' )
            // InternalDsl.g:15:9: ']]AASEntriesLOG_FINISH]]'
            {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDsl.g:1806:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalDsl.g:1806:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalDsl.g:1806:11: ( '^' )?
            int alt1=2;
            ...
            // InternalDsl.g:1806:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDsl.g:1808:10: ( ( '0' .. '9' )+ )
            // InternalDsl.g:1808:12: ( '0' .. '9' )+
            {
            // InternalDsl.g:1808:12: ( '0' .. '9' )+
            int cnt3=0;
            loop3:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDsl.g:1810:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalDsl.g:1810:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalDsl.g:1810:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // InternalDsl.g:1810:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalDsl.g:1810:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop4:
                    do {
                        int alt4=3;
                    ...
                    break;
                case 2 :
                    // InternalDsl.g:1810:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalDsl.g:1810:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDsl.g:1812:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalDsl.g:1812:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalDsl.g:1812:24: ( options {greedy=false; } : . )*
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDsl.g:1814:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalDsl.g:1814:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalDsl.g:1814:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDsl.g:1816:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalDsl.g:1816:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalDsl.g:1816:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt11=0;
            loop11:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDsl.g:1818:16: ( . )
            // InternalDsl.g:1818:18: .
            {
            matchAny(); 
    ...
    static final String DFA12_eotS =
        "\1\uffff\1\26\1\24\1\26\2\24\6\uffff\2\24\2\uffff\3\24\2\uffff\1\26\2\uffff\1\26\22\uffff\1\57\1\60\42\uffff";
    static final String DFA12_eofS =
        "\117\uffff";
    static final String DFA12_minS =
        "\1\0\1\101\1\72\1\115\1\133\1\135\6\uffff\1\41\1\101\2\uffff\2\0\1\52\2\uffff\1\123\2\uffff\1\123\2\101\20\uffff\2\60\2\101\2\uffff\2\123\2\105\2\156\2\164\2\162\2\151\2\145\2\163\2\114\2\117\2\107\2\137\2\103\4\uffff";
    static final String DFA12_maxS =
        "\1\uffff\1\101\1\72\1\115\1\133\1\135\6\uffff\1\137\1\172\2\uffff\2\uffff\1\57\2\uffff\1\123\2\uffff\1\123\2\101\20\uffff\2\172\2\101\2\uffff\2\123\2\105\2\156\2\164\2\162\2\151\2\145\2\163\2\114\2\117\2\107\2\137\1\123\1\106\4\uffff";
    static final String DFA12_acceptS =
        "\6\uffff\1\6\1\11\1\12\1\13\1\14\1\15\2\uffff\1\23\1\24\3\uffff\1\30\1\31\1\uffff\1\23\1\2\3\uffff\1\6\1\11\1\12\1\13\1\14\1\15\1\16\1\17\1\20\1\21\1\22\1\24\1\25\1\26\1\27\1\30\4\uffff\1\1\1\3\32\uffff\1\4\1\7\1\5\1\10";
    static final String DFA12_specialS =
        "\1\2\17\uffff\1\0\1\1\75\uffff}>";
    static final String[] DFA12_transitionS = {
            "\11\24\2\23\2\24\1\23\22\24\1\23\1\24\1\20\4\24\1\21\7\24\1\22\12\17\1\2\1\6\5\24\1\1\21\16\1\3\7\16\1\4\1\24\1\5\1\15\1\16\1\24\32\16\1\24\1\14\47\24\1\11\2\24\1\12\22\24\1\10\u02b5\24\1\13\u1caf\24\1\7\udfdf\24",
            "\1\25",
            "\1\27",
            "\1\30",
            "\1\31",
